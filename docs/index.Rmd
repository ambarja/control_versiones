...
.pull-left[
Cuando instalas **Git** por primera vez, es necesitas usar ciertas línas de comandos,a inicios puede ser algo tedioso, pero conforme vas practicando podrás ver las potencialidades que tiene y porque muchos usuarios hoy en día prefieren trabajar con una terminal dentro de su sitema operativo.Dentro de linux existe muchísimos líneas comandos que nos permite comunicar con el sistema operativo, aquí adjunto algunos comandos que pueden ser de vital importancia `CUANDO TRABAJES CON GIT`.

```
$ pwd             # Muestra el directorio actual
$ ls              # Lista el contenido actual
$ ls -a           # Muestra archivos ocultos
$ cd NAME_DIR     # Permite navegar por directorios
